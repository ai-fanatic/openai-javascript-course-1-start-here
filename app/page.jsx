...
export default function Home() {
  return (
    <div className="w-11/12 m-auto flex-col my-6">
      <h1 className={`text-center text-black ${instrumentSans.className}`}>
        The Home of Your AI-Langchain Toolkit
      </h1>
      <div className="flex flex-row justify-start">
        <div className="flex flex-col items-start justify-center min-h-screen text-gray-800 py-4 px-4 sm:px-6 lg:px-8 w-6/12">
          <h2
            className={`w-full text-4xl tracking-tight font-extrabold sm:text-5xl md:text-6xl text-left text-black ${pressStart2P.className}`}
          >
            Your AI-Langchain Bootcamp Starts Here
          </h2>
          <p
            className={`w-full mt-6 max-w-2xl text-center text-lg leading-7 sm:text-2xl sm:leading-9 sm:text-left lg:text-3xl text-black ${instrumentSans.className}`}
          >
      ...
      <p
        className={`w-full mt-4 text-center text-10 leading-7 sm:text-2xl sm:leading-9 sm:text-center lg:text-3xl text-black ${sourceCodePro.className}`}
      >
